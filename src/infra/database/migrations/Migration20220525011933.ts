...
export class Migration20220525011933 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "order" ("id" uuid not null, "code" varchar(255) not null, "value" decimal(16,2) not null, "reseller_id" uuid not null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) not null);');
